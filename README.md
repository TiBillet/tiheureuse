...
`# sur votre poste en local recupérez le ficjier install.sh puis copiez le sur le Pi
...
Les broches peuvent être modifiées dans le fichier .env généré, mais voici la configuration standard (BCM) :
